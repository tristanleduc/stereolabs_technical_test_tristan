...
random_indices = random.sample(range(0, len(train_dataset_ade20k)), 3000) 
...
val_loader_cityscapes = DataLoader(val_dataset_cityscapes, batch_size=15, shuffle=False)
val_loader_ade20k = DataLoader(val_dataset_ade20k, batch_size=15, shuffle=False)
